    ...
    <ol class="property-list person">
        ...
        <g:if test="${personInstance?.age}">
            <li class="fieldcontain">
                <span id="age-label" class="property-label"><g:message
                        code="person.age.label" default="Age"/></span>

                <span class="property-value"
                      aria-labelledby="age-label"><g:fieldValue
                        bean="${personInstance}" field="age"/></span>
        ...
        <g:if test="${personInstance?.description}">
            <li class="fieldcontain">
                <span id="description-label" class="property-label"><g:message
                        code="person.description.label"
                        default="Description"/></span>

                <span class="property-value"
                      aria-labelledby="description-label"><g:fieldValue
                        bean="${personInstance}" field="description"/></span>
            ...
            <li class="fieldcontain">
                ...
                <span class="property-value"
                      aria-labelledby="name-label"><g:fieldValue
                        bean="${personInstance}" field="name"/></span>

            </li>
        </g:if>

        <g:if test="${personInstance?.shard}">
            <li class="fieldcontain">
                <span id="shard-label" class="property-label"><g:message
                        code="person.shard.label" default="Shard"/></span>

                <span class="property-value"
                      aria-labelledby="shard-label"><g:fieldValue
                        bean="${personInstance}" field="shard"/></span>
